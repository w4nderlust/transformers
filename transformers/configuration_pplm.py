...
PPLM_PRETRAINED_CONFIG_ARCHIVE_MAP = {"pplm": "tbd/pytorch/pplm-config.json"}

class PPLMConfig(PretrainedConfig):
    ...
    """
    pretrained_config_archive_map = PPLM_PRETRAINED_CONFIG_ARCHIVE_MAP
        ...
        **kwargs
        ...
        Args:
            ...
            initializer_range: The sttdev of the truncated_normal_initializer for
                initializing all weight matrices.
        """
        super(PPLMConfig, self).__init__(**kwargs)
